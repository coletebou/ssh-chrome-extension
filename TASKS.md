...
|------|------------------|------|---------|
| Hetzner Server | 100.71.192.25 | deploy | Production server |
| Home Desktop | 100.115.178.39 | ctebou | Home dev (WSL) |
| Work Laptop | 100.95.16.127 | coletebou | Work laptop (WSL) |
